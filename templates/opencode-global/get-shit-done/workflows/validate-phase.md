...
```
Agent(
  prompt="Read /home/coringawc/.config/opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/coringawc/.config/opencode/get-shit-done/templates/VALIDATION.md`
