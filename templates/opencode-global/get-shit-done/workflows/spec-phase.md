...
```bash
INIT=$(node "/home/coringawc/.config/opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/coringawc/.config/opencode/get-shit-done/templates/spec.md.
