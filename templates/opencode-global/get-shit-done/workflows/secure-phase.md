...
```
Agent(
  prompt="Read /home/coringawc/.config/opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/coringawc/.config/opencode/get-shit-done/templates/SECURITY.md`
