...
```markdown
Read /home/coringawc/.config/opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/coringawc/.config/opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/coringawc/.config/opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/coringawc/.config/opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/coringawc/.config/opencode/agents/gsd-eval-planner.md for instructions.
