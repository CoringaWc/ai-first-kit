...
```bash
INIT=$(node "/home/coringawc/.config/opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/coringawc/.config/opencode/get-shit-done/bin/gsd-tools.cjs" commit \
