...
INSTALL_JS_GLOBAL="/home/coringawc/.config/opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/coringawc/.config/opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
