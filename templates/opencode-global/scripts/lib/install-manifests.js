...
const BUNDLED_SOURCE_ROOT = path.join(__dirname, '../..', 'ecc', 'ecc-source');
const DEFAULT_REPO_ROOT = fs.existsSync(path.join(BUNDLED_SOURCE_ROOT, 'manifests', 'install-modules.json'))
  ? BUNDLED_SOURCE_ROOT
  : path.join(__dirname, '../..');
