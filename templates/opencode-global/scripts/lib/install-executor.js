...
function getSourceRoot() {
  const bundledSourceRoot = path.join(__dirname, '..', '..', 'ecc', 'ecc-source');
  if (fs.existsSync(path.join(bundledSourceRoot, 'manifests', 'install-modules.json'))) {
    return bundledSourceRoot;
  }
