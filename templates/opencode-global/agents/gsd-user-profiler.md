...
<reference>
@/home/coringawc/.config/opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/coringawc/.config/opencode/get-shit-done/references/user-profiling.md` to load:
