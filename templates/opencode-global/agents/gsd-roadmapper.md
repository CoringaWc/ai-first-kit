...
Reference full template: `/home/coringawc/.config/opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/coringawc/.config/opencode/get-shit-done/templates/state.md`.
