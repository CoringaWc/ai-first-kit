...
```
Read("/home/coringawc/.config/opencode/ccg/.ccg/engine/strategies/{selected-strategy}.md")
```
...
3. 策略文件底部的 `## 铁律` 区块必须遵守
4. 如需调用外部模型，先 `Read("/home/coringawc/.config/opencode/ccg/.ccg/engine/model-router.md")` 获取调用模板
