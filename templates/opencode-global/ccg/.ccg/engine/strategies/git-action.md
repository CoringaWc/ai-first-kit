...
| 关键词 | 命令文件 | 说明 |
|--------|---------|------|
| commit, 提交 | `/home/coringawc/.config/opencode/ccg/commands/ccg/commit.md` | 智能提交（conventional commit） |
| rollback, 回滚, revert, undo | `/home/coringawc/.config/opencode/ccg/commands/ccg/rollback.md` | 交互式回滚 |
| clean branch, 清理分支 | `/home/coringawc/.config/opencode/ccg/commands/ccg/clean-branches.md` | 清理已合并分支 |
| worktree | `/home/coringawc/.config/opencode/ccg/commands/ccg/worktree.md` | Worktree 管理 |
