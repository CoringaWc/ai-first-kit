---
name: ccg-frontend-design
description: "CCG: Use para design frontend, tipografia, cores OKLCH, espaçamento, motion, interação, responsividade, UX writing, estados e qualidade visual anti-slop."
...
All commands are in `/home/coringawc/.config/opencode/ccg/skills/ccg/impeccable/`. Each invokes this skill's guidelines first.
