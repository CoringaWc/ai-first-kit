---
name: ccg-multi-agent
description: "CCG: Use para orquestração multiagente, papéis, ciclo de vida, comunicação por feromônios, decomposição de tarefas e resolução de conflitos."
license: MIT
