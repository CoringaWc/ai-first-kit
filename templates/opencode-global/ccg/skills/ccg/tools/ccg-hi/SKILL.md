---
name: ccg-hi
description: "CCG: Use para o comando /hi, substituindo a última resposta do modelo por um template genérico de concordância."
license: MIT
...
- Claude Code: `/home/coringawc/.config/opencode/projects/<cwd-slug>/*.jsonl`（按 mtime 取最新）
- Codex CLI: `/home/coringawc/.codex/sessions/YYYY/MM/DD/rollout-*.jsonl`（递归扫描按 mtime 取最新）
