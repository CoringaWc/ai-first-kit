---
name: ccg-scrapling
description: "CCG: Use com scrapling para scrape, crawl, fetch de páginas, extração de dados, parsing HTML, coleta em lote e bypass de Cloudflare/WAF quando aplicável."
user-invocable: true
