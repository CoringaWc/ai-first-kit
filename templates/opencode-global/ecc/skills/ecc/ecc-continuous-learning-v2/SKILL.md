...
description: "ECC: Use para sistema de aprendizado contínuo por instintos, observando sessões via hooks, criando instintos atômicos com confiança e evoluindo para skills, comandos ou agentes."
origin: ECC
version: 2.1.0
---
