---
name: ecc-code-tour
description: "ECC: Use para criar arquivos .tour do CodeTour com walkthroughs ancorados em arquivos e linhas, para onboarding, arquitetura, PRs, RCA ou explicações estruturadas."
origin: ECC
---
