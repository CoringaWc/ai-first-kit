...
description: "ECC: Use para loop de verificação Laravel com env checks, lint, static analysis, testes com cobertura, scans de segurança e prontidão de deploy."
origin: ECC
---
