...
description: "ECC: Use para Prisma em backends TypeScript, incluindo schema, otimização, transações, paginação e armadilhas como updateMany, $transaction, migrate dev, @updatedAt e serverless."
origin: ECC
---
