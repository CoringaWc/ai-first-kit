...
description: "ECC: Use ao adicionar autenticação, lidar com entrada do usuário, secrets, endpoints de API, pagamentos ou recursos sensíveis; fornece checklist e padrões de segurança."
origin: ECC
---
