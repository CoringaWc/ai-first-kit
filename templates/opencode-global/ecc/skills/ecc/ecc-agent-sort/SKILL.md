---
name: ecc-agent-sort
description: "ECC: Use para montar um plano de instalação ECC enxuto para um repositório, classificando skills, comandos, regras, hooks e extras em uso diário versus biblioteca."
origin: ECC
---
