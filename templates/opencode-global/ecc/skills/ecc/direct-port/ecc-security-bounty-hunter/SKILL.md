...
description: "ECC: Use para caçar vulnerabilidades exploráveis e qualificáveis para bounty em repositórios, focando achados remotos reais em vez de ruído local."
