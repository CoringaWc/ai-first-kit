...
description: "ECC: Use para evitar bugs de hashing Ethereum em JavaScript/TypeScript; Node sha3-256 não é Keccak-256 e quebra selectors, assinaturas, slots e endereços."
