...
description: "Global: Use para auditoria local de prontidão de produção em apps, revisões pré-lançamento, checagens pós-merge e perguntas do tipo o que quebra em produção sem enviar código a serviço externo."
origin: community
---
