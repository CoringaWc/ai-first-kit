...
description: "Global: Use em aplicações de saúde que lidam com PHI/PII, privacidade, classificação de dados, controle de acesso, auditoria, criptografia e vetores comuns de vazamento."
