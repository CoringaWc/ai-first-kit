---
description: "Continuous Learning: Exporta instincts para compartilhamento."
agent: build
---
...
Export instincts from the continuous-learning-v2 system by running:

```bash
python3 /home/coringawc/.config/opencode/ecc/skills/ecc/ecc-continuous-learning-v2/scripts/instinct-cli.py export $ARGUMENTS
```
...
This maps to `--output ./my-instincts.json` on the underlying CLI.
