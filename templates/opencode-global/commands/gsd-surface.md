---
description: "GSD: Alterna quais skills sao surfaced por perfil ou cluster."
...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/coringawc/.config/opencode/.gsd-surface.json`
(sibling to `/home/coringawc/.config/opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/coringawc/.config/opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/coringawc/.config/opencode/skills`).
...
`/home/coringawc/.config/opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/coringawc/.config/opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/coringawc/.config/opencode/.gsd-surface.json`
Install profile marker: `/home/coringawc/.config/opencode/.gsd-profile`
Skill dirs: `/home/coringawc/.config/opencode/skills/gsd-*/`
Engine module: `/home/coringawc/.config/opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/coringawc/.config/opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
