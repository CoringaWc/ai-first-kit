---
description: "Continuous Learning: Importa instincts de fontes externas."
agent: build
---
...
Import instincts into the continuous-learning-v2 system by running:

```bash
python3 /home/coringawc/.config/opencode/ecc/skills/ecc/ecc-continuous-learning-v2/scripts/instinct-cli.py import $ARGUMENTS
```
